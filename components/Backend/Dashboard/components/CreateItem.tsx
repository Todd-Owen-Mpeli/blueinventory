...
const CreateItem: FC = () => {
	...
	return (
		<>
			<AnimatePresence>
				{dashboardLayoutContext?.revealCreateItemModal && (
					<>
						<motion.div
							initial={{opacity: 0}}
							animate={{opacity: 1}}
						...
						<div className="fixed top-0 left-0 z-50 flex w-full h-full px-4 py-24 overflow-y-scroll">
							<div className="relative m-auto bg-white rounded-lg">
								...
								<motion.button
									...
									animate={{opacity: 1}}
									exit={{opacity: 0}}
									onClick={dashboardLayoutContext?.handleCloseCreateItemModal}
									...
									<div className="px-4 overflow-hidden lg:px-0">
										<div className="pl-3/20">
											<div className="relative">
												<div
													className={styles.createItem + " w-full p-8 max-w-xl"}
												>
													<Formik
															...
															{loading ? (
																...
																>
																	<h4 className="text-xl font-semibold text-center uppercase text-darkBlue">
																		Error Message: Something went wrong with
																		creating your item. Please try again.
																	</h4>
																</motion.div>
															) : (
																<motion.h3
