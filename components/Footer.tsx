...
import FooterMenuLinks from "./Cards/FooterMenuLinks";
...
const Footer: FunctionComponent<IProps> = ({email}) => {
						...
						<div className="flex flex-col px-4 lg:px-2 sm:grid sm:grid-cols-2 lg:flex lg:px-4 lg:flex-row justify-between">
							...
							<div className="col-6 col-mx-auto lg:mb-8 lg:mt-0 my-4">
								...
								<ul className="list-unstyled flex flex-col gap-2">
									...
									<Link
										href={`#`}
										className="inline-block text-decoration-none text-black"
									>
										Integrations
									</Link>
									<Link
							...
							<div className="col-6 col-mx-auto lg:mb-8 lg:mt-0 my-4">
								...
								<ul className="list-unstyled mb-6 flex flex-col gap-2">
									<Link href={`#`}>
										<span className="mb-4 flex justify-start items-center gap-5 text-decoration-none text-black">
								...
								<div className={styles.alreadySingedIn}>
									...
									<Link href={`#`}>
										<span className="btn p-0 flex justify-center items-center gap-3 text-success text-blue hover:ease-in-out hover:duration-300">
											<span>Sign in</span>
											<svg
												width="14"
												height="11"
				...
				<div className="py-8 bg-white">
					<div className="container mx-auto px-4">
						<div className="flex flex-col md:flex-row justify-between items-center">
							...
							<div className="flex order-first md:order-last gap-10 mb-6 md:mb-0">
								<Link
									href={`#`}
									className="inline-flex items-center w-12 h-12 mr-4"
								>
									<svg
								...
								<Link href={`#`} className="inline-flex items-center w-12 h-12">
									<svg
										className="mx-auto text-black hover:text-blue h-4 w-4"
										viewBox="0 0 18 18"
										fill="currentColor"
