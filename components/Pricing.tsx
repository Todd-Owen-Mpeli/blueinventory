						...
						<motion.div variants={stagger} className="flex flex-wrap -mx-4">
							...
							>
								<div className="max-w-sm p-10 mx-auto bg-blue rounded-3xl">
									...
									<div className="mt-6">
										<span className="block mb-4 text-white text-base">
											What&apos;s included:
										</span>
										<ul className="mb-10">
											<motion.ul variants={stagger}>
										...
										<Link
											className="relative inline-block py-4 overflow-hidden text-sm font-semibold text-center transition duration-200 rounded-full bg-goldPrime group px-7 text-white hover:text-goldPrime"
											href={`/checkout`}
										>
